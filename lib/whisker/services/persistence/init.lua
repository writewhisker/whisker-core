...
PersistenceService.version = "2.1.0"

--- Create a new persistence service instance
-- @param container Container The DI container
-- @return PersistenceService
function PersistenceService.new(container)
  local self = {
    ...
    _platform = container and container:has("platform") and container:resolve("platform") or nil,
...
function PersistenceService:save(slot, metadata)
  ...
  if self._platform and self._platform.save then
    ...
    if success and self._events then
