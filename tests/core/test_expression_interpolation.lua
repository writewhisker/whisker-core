  ...
  describe("LuaInterpreter.evaluate_expression", function()
    ...
    describe("simple expressions", function()
      ...
      it("should evaluate arithmetic", function()
        ...
        local result, err = interpreter:evaluate_expression("1 + 2", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate variable + literal", function()
        ...
        local result, err = interpreter:evaluate_expression("count + 10", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate multiplication", function()
        ...
        local result, err = interpreter:evaluate_expression("x * 2", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate division", function()
        ...
        local result, err = interpreter:evaluate_expression("total / parts", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate modulo", function()
        ...
        local result, err = interpreter:evaluate_expression("x % 5", game_state)
        assert.is_nil(err)
    ...
    describe("property access", function()
      ...
      it("should access nested properties", function()
        ...
        local result, err = interpreter:evaluate_expression("player.name", game_state)
        assert.is_nil(err)
      ...
      it("should access deeply nested properties", function()
        ...
        local result, err = interpreter:evaluate_expression("player.inventory.gold", game_state)
        assert.is_nil(err)
    ...
    describe("function calls", function()
      ...
      it("should evaluate math functions", function()
        ...
        local result, err = interpreter:evaluate_expression("math.abs(a)", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate math.max", function()
        ...
        local result, err = interpreter:evaluate_expression("math.max(a, b)", game_state)
        assert.is_nil(err)
      ...
      it("should evaluate math.floor", function()
        ...
        local result, err = interpreter:evaluate_expression("math.floor(x)", game_state)
        assert.is_nil(err)
        assert.equals(3, result)
      end)
    ...
    describe("string expressions", function()
      ...
      it("should concatenate strings", function()
        ...
        local result, err = interpreter:evaluate_expression('first .. " " .. last', game_state)
        assert.is_nil(err)
      ...
      it("should call string functions", function()
        ...
        local result, err = interpreter:evaluate_expression("string.upper(name)", game_state)
        assert.is_nil(err)
        assert.equals("ALICE", result)
      end)
      ...
      it("should get string length", function()
        ...
        local result, err = interpreter:evaluate_expression("string.len(text)", game_state)
        assert.is_nil(err)
        assert.equals(5, result)
      end)
    ...
    describe("comparison expressions", function()
      ...
      it("should evaluate equality", function()
        local game_state = create_mock_game_state({x = 10})
        local result, err = interpreter:evaluate_expression("x == 10", game_state)
        assert.is_nil(err)
        assert.is_true(result)
      end)
    ...
    describe("error handling", function()
      ...
      it("should handle undefined variables gracefully", function()
        local game_state = create_mock_game_state({})
        local result, err = interpreter:evaluate_expression("undefined_var", game_state)
        assert.is_nil(err)
      ...
      it("should return error for empty expression", function()
        local game_state = create_mock_game_state({})
        local result, err = interpreter:evaluate_expression("", game_state)
        assert.is_not_nil(err)
      end)
